...
import 'package:flutter_iot_pet_app/presentation/pages/custom_camera_preview_page.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Switch(
                              ...
                              onChanged: (_) => ref
                                  .read(isStatusVisibleProvider.notifier)
                                  .toggle(),
                            ),
                          ],
                        ),
              ...
              Text('GraphQl top countries with dog owners list'),
              countriesAsync.when(
              ...
              if (showLocation) Text('📍 Location: ${petLocation.value ?? ''}'),
              if (showTemperature)
                Text(
                    '🌡️ Temp: ${petTemperature.value?.toStringAsFixed(1) ?? ''} °C'),
              if (showHeartRate)
                Text('❤️ Heart Rate: ${petHeartRate.value ?? ''} bpm'),
              if (showBattery) Text('🔋 Battery: ${petBattery.value ?? ''} %'),
              if (showFirmware)
              ...
              _iotToggleButton(
                ...
                onToggle: () => ref.read(showLocationProvider.notifier).state =
                    !showLocation,
              ),
              _iotToggleButton(
                context,
              ...
              _iotToggleButton(
                ...
                onToggle: () => ref.read(showHeartRateProvider.notifier).state =
                    !showHeartRate,
              ),
              _iotToggleButton(
                context,
                ...
                onToggle: () =>
                    ref.read(showBatteryProvider.notifier).state = !showBattery,
              ),
              _iotToggleButton(
                context,
                label: 'Firmware',
                ...
                onToggle: () => ref.read(showFirmwareProvider.notifier).state =
                    !showFirmware,
              ),
              _iotToggleButton(
                context,
              ...
              ElevatedButton(
                ...
                child: const Text('Open Pet Camera'),
              ),
              ElevatedButton(
                onPressed: () {
                  Navigator.push(
